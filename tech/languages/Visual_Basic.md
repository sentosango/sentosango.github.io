...
Один из первых языков программирования, с которым началось мое знакомство с программированием. На тот момент это был Visual Basic v6, урезанная версия которого (VBA) была интегрирована в офисный пакет MS Office.
