...
**Применение:** BTrud (2018-2019) — первичные наброски, Morizo (2021-2024) — админ-панели для CMS и туристического портала
...
**Применение:** Inboxly (2021) — веб и десктоп из одной кодовой базы, Content Store — начало разработки клиента
...
**Применение:** TRM (2015-2016), DSE (2016-2016), Appwilio (2016-2017), BTrud (2018-2019), Morizo (2021-2024)
...
**Применение:** Morizo (2021-2024), BTrud (2018-2019), Inboxly, Content Store
...
**Применение:** TRM (2015-2016), BTrud (2018-2019), Morizo (2021-2024)
...
**Применение:** TRM (2015-2016) — более 2000 интеграционных тестов, Appwilio (2016-2017), BTrud (2018-2019) — 100% покрытие, Morizo (2021-2024), Inboxly, Content Store
...
**Применение:**
- Рабочие: TRM (2015-2016) — более 2000 интеграционных тестов API, DSE (2016-2016), Appwilio (2016-2017), BTrud (2018-2019) — 100% покрытие тестами, Morizo (2021-2024)
- Личные: Content Store, Inboxly, WantUs
- Open-source: Vk Client, Laravel Vk Requester, Content Store/content-fetcher, Php Client (openai, ollama, tailscale, keenetic, syncthing)
...
**Применение:** TRM (2015-2016), DSE (2016-2016), Appwilio (2016-2017), BTrud (2018-2019), Morizo (2021-2024), все личные проекты на PHP
...
**Опыт:**
- BTrud (2018-2019) — настройка с нуля
- Morizo (2021-2024) — доработка и использование
...
**Применение:**
- Morizo (2021-2024): Mosreg CMS — RBAC для админ-панели; Туристический портал —  для админ-панели и для личного кабинета
- BTrud (2018-2019): роли админ, работодатель, соискатель с разными интерфейсами и доступными методами API
- DSE (2016-2016): система ролей была отлажена до прихода в проект
- TRM (2015-2016): три основных категории пользователей с разными интерфейсами личного кабинета и правами
